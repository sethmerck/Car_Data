...
## box plot #
a, b = plt.subplots(1,2, figsize=(7,3))
...
sorted_box = sorted_prev_data.boxplot(column='Price', by="Car", rot=35, ax=b[0])
box = sorted_data.boxplot(column='Price', by="Car", rot=35, ax=b[1])
